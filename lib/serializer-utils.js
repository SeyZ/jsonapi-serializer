...
module.exports = function (collectionName, record, payload, opts) {
  ...
  function getType(str, attrVal) {
    ...
    // If the pluralizeType is set and typeForAttribute returned undefined or wasn't used
    if (isFunction(opts.pluralizeType) && type === undefined) {
      type = opts.pluralizeType(str);
    }
